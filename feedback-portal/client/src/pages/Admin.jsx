...
export default function Admin() {
  ...
  // right panel: selected row + comments
    ...
    <div className="app-shell">
      ...
      <div className="side">
        ...
        <div className="panel">
                    ...
                    <td className="td">
                      <div style={{display:'flex', gap:8, flexWrap:'wrap'}}>
                        ...
                        <button
                          className="btn"
                          style={{padding:'8px 10px'}}
                          onClick={() => { setSel(row); loadComments(row.id); }}
                        >
                          View thread
                        </button>
                      </div>
          ...
          {actionMsg && (
            <div className={`alert ${actionMsg.type === "ok" ? "success" : ""}`} style={{marginTop:10}}>
              {actionMsg.text}
            </div>
          )}
        </div>
        ...
        <div className="panel">
          <h3 className="h1" style={{fontSize:22, marginBottom:10}}>Thread</h3>
          {!sel ? (
            <p className="p">Select a feedback row and click <b>View thread</b>.</p>
          ) : (
            <>
