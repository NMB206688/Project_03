...
export default function Submit() {
  ...
  return (
    ...
    <main className="page-center">
      ...
      <div className="stack" style={{ width: "100%", maxWidth: 720 }}>
        {/* Main form card */}
        <div className="card form-card">
          ...
          <p className="p" style={{ textAlign: "center" }}>
            Suggestions, bugs, or improvement ideas—everything helps. You can
            submit anonymously.
          </p>

          {/* Compact the vertical gaps inside the form */}
          <form className="row" onSubmit={handleSubmit} style={{ display: "grid", gap: 12 }}>
            ...
            <div
              style={{
                display: "flex",
                gap: 12,
                marginTop: 2,       // tighten gap above buttons
            ...
            {msg && (
              <div
                className={`alert ${msg.type === "ok" ? "success" : ""}`}
        ...
        {/* Optional: latest items under the form (still centered) */}
        {authed && (
          <div className="card">
            <h2 className="h1" style={{ fontSize: 22, textAlign: "center" }}>
